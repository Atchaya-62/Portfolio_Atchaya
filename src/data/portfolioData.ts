...
export const portfolioData: PortfolioData = {
  ...
  projects: [
    ...
    {
      id: 'recall-ai-learning-platform',
      title: 'Recall - AI Learning Platform',
      description: 'AI learning platform that auto-curates personalized YouTube courses by topic & level, generates smart flashcards, and gamifies progress with XP streaks — turning passive watching into measurable mastery.',
    ...
    },
    {
      ...
      title: 'NotinQ - Canteen Management System',
      description: 'Smart canteen management system that streamlines ordering, inventory, and queue management — reducing wait times and operational chaos through intelligent automation and real-time tracking.',
  ...
  certifications: [
    {
      ...
      certificateUrl: 'https://drive.google.com/file/d/1fpwO1VpibhjxVGcdGnXXUe5rgNhET0T4/view?usp=sharing',
    },
    {
      id: 'aws-cert',
